...
HELP_MESSAGE = 'Доступные команды бота: ' \
              '\n\n**ху** - выбирает рандомного пользователя и ' \
              'показывает ему рандомное предложение из массива слов' \
              ...
              '\n**полл** - создаёт простейшее голосование с ' \
              'выборами голосов "За" и "Против"' \
